...
void calibrationRene()
{
  if (!digitalRead(CALIB_BUTTON))
  {
    ...
    setZeroPositionAsPos(&servo1, 2048);
    delay(100);
    setZeroPositionAsPos(&servo2, 0);
    delay(100);
    setZeroPositionAsPos(&servo3, 0);
    delay(100);
    setZeroPositionAsPos(&servo4, 0);
    delay(100);

    servo2.setGoalPosition(2048, 1000);
    delay(700);
    servo3.setGoalPosition(2048, 1000);
    delay(700);
    servo4.setGoalPosition(200, 1000);
    delay(700);
    ...
    servo2.setGoalPosition(200, 1000);
    delay(700);
    servo3.setGoalPosition(900, 1000);
    delay(700);
    servo4.setGoalPosition(0, 1000);
    delay(700);
