...
class OCServo {
    ...
    public:
        ...
        OCSResponse setCWDeadband(byte deadband);
        OCSResponse setCCWDeadband(byte deadband);

        OCSResponse setZeroCorrection(int correction);
        int getCurrentPosition();
        OCSResponse setLockSign(byte lock);
